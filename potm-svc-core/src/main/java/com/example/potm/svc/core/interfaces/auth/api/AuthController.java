package com.example.potm.svc.core.interfaces.auth.api;

import cn.dev33.satoken.annotation.SaIgnore;
import com.example.potm.svc.core.application.AuthApplication;
import com.example.potm.svc.core.interfaces.auth.dto.LoginByUsernameDTO;
import com.example.potm.svc.core.interfaces.auth.vo.UserInfoVO;
import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;
import org.example.framework.config.cdc.NotLog;
